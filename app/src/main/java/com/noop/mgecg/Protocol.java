...
public final class Protocol {
    ...
    public static byte[] labrador(int type, int cmd, int arg, int seq) {
        return labradorBytes(type, cmd, new byte[]{(byte)arg}, seq);
    }

    public static byte[] labradorU32(int type, int cmd, long arg32, int seq) {
        byte[] a = new byte[4];
        a[0]=(byte)(arg32&0xff); a[1]=(byte)((arg32>>>8)&0xff); a[2]=(byte)((arg32>>>16)&0xff); a[3]=(byte)((arg32>>>24)&0xff);
        return labradorBytes(type, cmd, a, seq);
    }
